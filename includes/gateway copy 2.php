...
class PayInvert extends WC_Payment_Gateway
{
    public function __construct()
    {
        ...
        add_action('admin_post_regenerate_auth_header_value', array($this, 'handle_regenerate_auth_header_value'));
    ...
    public function init_form_fields()
    {
        ...
        $this->form_fields = array(
            ...
            'regenerate_auth_header_value' => array(
                'title' => '',
                'type'              => 'button',
                'description'       => 'Click this button to regenerate the Authorization Header Value.',
                'desc_tip'          => false,
                'custom_attributes' => array(
                    'onclick' => 'return handleRegenerateAuthHeader();',
                ),
            )
        );
    }
    ...
    public function handle_regenerate_auth_header_value()
    {
        ...
        // Redirect back to the settings page after successful regeneration
        wp_redirect(admin_url('admin.php?page=wc-settings&tab=checkout&section=payinvert'));
        exit;
    }
